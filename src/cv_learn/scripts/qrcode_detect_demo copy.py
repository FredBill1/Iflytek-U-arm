...
dist = np.array([-0.318607, 0.097228, 0.000029, 0.000642, 0.0])
...
directory = aruco.getPredefinedDictionary(cv2.aruco.DICT_6X6_250)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if type(ids) != type(None):
            ...
            print("x:%.2f,y:%.2f,z:%.2f" % (tvec[0], tvec[1], tvec[2]))
